...
impl G2P {
    #[new]
    #[pyo3(signature = (dict_path, lang = "vi"))]
    fn new(dict_path: &str, lang: &str) -> PyResult<Self> {
        let engine = g2p::G2PEngine::new(dict_path)
            .map_err(|e| pyo3::exceptions::PyIOError::new_err(e.to_string()))?;
        let normalizer = normalizer::Normalizer::new(lang);
    ...
    fn pipeline(&self, text: &str) -> PyResult<String> {
