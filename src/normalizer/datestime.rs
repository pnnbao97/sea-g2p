...
use crate::normalizer::num2vi::n2w;
use crate::normalizer::resources::{DATE_KEYWORDS, MATH_KEYWORDS};
...
pub fn normalize_date(text: &str) -> String {
    ...
    result = RE_REDUNDANT_NGAY.replace_all(&result, "ngày").to_string();
    result = RE_REDUNDANT_THANG.replace_all(&result, "tháng").to_string();
    result = RE_REDUNDANT_NAM.replace_all(&result, "năm").to_string();
